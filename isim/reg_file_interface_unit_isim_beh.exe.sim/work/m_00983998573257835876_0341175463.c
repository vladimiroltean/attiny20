...
#endif
static const char *ng0 = "/media/aldi/Little Seagate/Scoala/Facultate/nesortate/verilog/rezolvare/reg_file_interface_unit.v";
static int ng1[] = {0, 0};
static int ng2[] = {2, 0};
static int ng3[] = {12, 0};
static int ng4[] = {4, 0};
...
LAB23:    t242 = *((unsigned int *)t4);
    t243 = (~(t242));
    t244 = *((unsigned int *)t80);
    t245 = (t243 || t244);
    if (t245 > 0)
        goto LAB24;
...
LAB30:    t246 = (t0 + 10232);
    ...
    *((unsigned int *)t256) = (t258 | t252);
    xsi_driver_vfirst_trans(t246, 0, 4);
    t259 = (t0 + 9784);
    *((int *)t259) = 1;
...
LAB42:    memcpy(t84, t103, 8);

LAB43:    goto LAB23;

LAB24:    t239 = ((char*)((ng24)));
    goto LAB25;

LAB26:    xsi_vlog_unsigned_bit_combine(t3, 32, t84, 32, t239, 32);
    goto LAB30;
...
LAB55:    memcpy(t103, t122, 8);

LAB56:    goto LAB38;

LAB39:    xsi_vlog_unsigned_bit_combine(t84, 32, t98, 32, t103, 32);
    goto LAB43;

LAB41:    memcpy(t84, t98, 8);
    goto LAB43;
...
LAB68:    memcpy(t122, t141, 8);

LAB69:    goto LAB51;

LAB52:    xsi_vlog_unsigned_bit_combine(t103, 32, t117, 32, t122, 32);
    goto LAB56;

LAB54:    memcpy(t103, t117, 8);
    goto LAB56;
...
LAB79:    memcpy(t191, t161, 8);

LAB80:    memset(t142, 0, 8);
    t223 = (t191 + 4);
...
LAB97:    if (*((unsigned int *)t142) > 0)
        goto LAB98;

LAB99:    memcpy(t141, t241, 8);

LAB100:    goto LAB64;

LAB65:    xsi_vlog_unsigned_bit_combine(t122, 32, t136, 32, t141, 32);
    goto LAB69;

LAB67:    memcpy(t122, t136, 8);
    goto LAB69;
...
LAB82:    if (*((unsigned int *)t184) != 0)
        goto LAB83;

LAB84:    t192 = *((unsigned int *)t161);
...
LAB96:    xsi_vlog_unsigned_bit_combine(t141, 32, t234, 32, t241, 32);
    goto LAB100;

LAB98:    memcpy(t141, t234, 8);
    goto LAB100;
...
extern void work_m_00983998573257835876_0341175463_init()
{
	static char *pe[] = {(void *)Cont_49_0,(void *)Cont_53_1,(void *)Cont_57_2,(void *)Cont_65_3,(void *)Cont_73_4,(void *)Cont_82_5,(void *)Cont_84_6,(void *)Cont_86_7,(void *)Cont_88_8,(void *)Cont_90_9,(void *)Cont_91_10,(void *)Cont_92_11,(void *)Cont_94_12,(void *)Cont_96_13,(void *)Cont_97_14};
	xsi_register_didat("work_m_00983998573257835876_0341175463", "isim/reg_file_interface_unit_isim_beh.exe.sim/work/m_00983998573257835876_0341175463.didat");
